import { compileRendererIr, legacyDesignMdToDocument, renderDesignMd } from "./design-document";
import type { DesignSystem } from "./catalog";

type CatalogMetadata = Omit<
  DesignSystem,
  "name" | "description" | "document" | "renderer" | "designMd"
>;

function publishCatalogSystem(metadata: CatalogMetadata, designMd: string): DesignSystem {
...
export const catalogFixtures: DesignSystem[] = [
